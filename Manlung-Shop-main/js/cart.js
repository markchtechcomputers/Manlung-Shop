...
function renderCartUI() {
  ...
  if (cart.length === 0) { 
    cont.innerHTML = "<div style='text-align:center; padding:48px 20px; color:#7d8bab;'><div style='font-size:2.5rem; margin-bottom:12px;'>🛒</div><div style='font-weight:600; color:#16213e; margin-bottom:4px;'>Your cart is empty</div></div>"; 
