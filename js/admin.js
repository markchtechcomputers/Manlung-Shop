...
function renderAllTabs() {
   ...
   renderCategory("newArrivals", "newArrivals", ["title", "price", "unit", "imgUrl", "images", "featured", "soldOut", "discount"]);
   renderCategory("sponsored", "sponsored", ["title", "price", "unit", "imgUrl", "images", "soldOut", "discount", "sponsoredType"]);
 }
...
function fieldLabel(f) {
   const labels = {
     ...
     comingSoon: "Coming Soon", discount: "Discount (%)", category: "Category",
     tracks: "Tracklist", colors: "Colours", sizes: "Sizes", sponsoredType: "Sponsored Type"
   };
   return labels[f] || f;
 }
...
const newArrivals = ${JSON.stringify(d.newArrivals, null, 2)};

const sponsored = ${JSON.stringify(d.sponsored, null, 2)};

const recentlyViewed = ${JSON.stringify(d.recentlyViewed, null, 2)};

const allProducts = [...digitalProducts, ...cdProducts, ...newArrivals, ...sponsored];
...
document.getElementById("addDigitalBtn").addEventListener("click", () =>
   ...
   document.getElementById("saveNewArrivalsBtn").addEventListener("click", () =>
    saveCategory("newArrivals", "newArrivals", ["title", "price", "unit", "imgUrl", "images", "featured", "soldOut", "discount"]));
   document.getElementById("addNewArrivalsBtn").addEventListener("click", () =>
    addItem("newArrivals", { title: "New Arrival", price: 199, unit: "per item", imgUrl: "https://placehold.co/600x600/eef1f8/0b2a6b?text=NEW", images: ["https://placehold.co/600x600/eef1f8/0b2a6b?text=NEW"], featured: false, stock: 999, soldOut: false, discount: 0 }));

   document.getElementById("saveSponsoredBtn").addEventListener("click", () =>
    saveCategory("sponsored", "sponsored", ["title", "price", "unit", "imgUrl", "images", "soldOut", "discount", "sponsoredType"]));
   document.getElementById("addSponsoredBtn").addEventListener("click", () =>
    addItem("sponsored", { title: "Sponsored Item", price: 199, unit: "per item", imgUrl: "https://placehold.co/600x600/eef1f8/0b2a6b?text=SPONSORED", images: ["https://placehold.co/600x600/eef1f8/0b2a6b?text=SPONSORED"], soldOut: false, stock: 999, discount: 0, sponsoredType: "paid" }));
