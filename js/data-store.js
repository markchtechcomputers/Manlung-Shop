...
(function () {
  ...
  function loadFromLocalStorage() {
   ...
   try {
     ...
     const stored = localStorage.getItem("manlung_recently_viewed");
     if (stored) {
       try { window.productData.recentlyViewed = JSON.parse(stored); } catch(e) {}
     }
   } catch (e) {
  ...
  function rerenderEverything() {
    ...
    window.renderFunctions?.renderNewArrivals();
    window.renderFunctions?.renderSponsored();
    window.renderFunctions?.renderRecentlyViewed();
  ...
  function applyIncoming(parsed) {
   if (!parsed) return;
   parsed.allProducts = [...(parsed.digitalProducts || []), ...(parsed.cdProducts || [])];
   parsed.recentlyViewed = parsed.recentlyViewed || window.productData?.recentlyViewed || [];
   window.productData = parsed;
   const stored = localStorage.getItem("manlung_recently_viewed");
   if (stored) {
     try { window.productData.recentlyViewed = JSON.parse(stored); } catch(e) {}
  ...
  function saveToStorage() {
    window.productData.allProducts = [
      ...window.productData.digitalProducts,
      ...window.productData.cdProducts,
      ...window.productData.newArrivals,
      ...window.productData.sponsored
    ];
    saveToLocalStorage();
    try {
      localStorage.setItem("manlung_recently_viewed", JSON.stringify(window.productData.recentlyViewed || []));
    } catch(e) {}
  ...
  function resetToDefaults() {
    ...
    localStorage.removeItem("manlung_recently_viewed");
