...
function initRateCardDownload() {
  ...
  btn.addEventListener("click", async () => {
    ...
    // Common mistake: pasting the postimg.cc VIEWER page instead of the direct image link.
    // A direct link is on the i.postimg.cc subdomain and ends in a real file extension.
    const looksLikeDirectImage = /^https?:\/\/i\.postimg\.cc\/.*\.(jpg|jpeg|png|webp|gif)$/i.test(url) || /\.(jpg|jpeg|png|webp|gif)$/i.test(url);
